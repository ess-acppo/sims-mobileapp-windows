...
$(document).on('click', '.sync', function (event) {
    ...
    $.each(results.observations, function (index, value) {
        ...
        if (result.vError === 0) {
            ...
            $.alert({
                title: 'Payload Sent!',
                content: vpayload.escapeSpecialChars(),
                columnClass: 'col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-1 col-xs-10 col-xs-offset-1'
            });
            //var payload = {
                                        ...
                                        $.alert({
                                            ...
                                            buttons: {
                                                Ok: function () {
                                                    $.alert({
                                                        title: 'Settings',
                                                        content: JSON.stringify(resSettings),
                                                        columnClass: 'col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-1 col-xs-10 col-xs-offset-1',
                                                        buttons: {
                                                            Ok: function () { }
                                                        }
