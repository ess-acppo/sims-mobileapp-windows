    ...
    $.ajax({
        ...
        setTimeout(function (e) {
            if (curIdx > -1) {
                ...
                today = yyyy.toString() + '-' + mm.toString() + '-' + dd.toString() + 'T00:00:00';
